<template>
    <ion-grid v-for="item in toRecieveOrders" :key="item" class="ion-margin-top">
        <ion-row>
            <ion-col>
                <ion-label>{{item.seller_details.username}}</ion-label>
            </ion-col>
            <ion-col size="2.7">
                <ion-label style="color: #ffc107;">To Recieve</ion-label>
            </ion-col>
        </ion-row>
        <ion-row>
            <ion-col size="4">
        ...
        <ion-row style="font-size: 12px; color: #58a89d;">
            <ion-col size="1">
                <ion-icon size="small" name="bus-outline" />
            </ion-col>
            <ion-col >
                <ion-label>Product is on its way</ion-label>
            </ion-col>
        </ion-row>
    </ion-grid>
</template>
